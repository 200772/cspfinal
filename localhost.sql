...
--
-- Host: localhost
-- Generation Time: May 30, 2018 at 05:04 PM
...
--
-- Table structure for table `whichEvents`
--

CREATE TABLE IF NOT EXISTS `whichEvents` (
  `studentName` varchar(128) CHARACTER SET utf8 NOT NULL,
  `eventName` varchar(128) CHARACTER SET utf8 NOT NULL,
  `age` varchar(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`studentName`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `whichEvents`
--

INSERT INTO `whichEvents` (`studentName`, `eventName`, `age`) VALUES
('Dean Luehrs', '100 Meter', '11');
--
-- Database: `phpmyadmin`
--
...
CREATE TABLE IF NOT EXISTS `student` (
  `competitionID` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `StudentName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `event` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `year` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `student` (`competitionID`, `StudentName`, `event`, `year`) VALUES
(26, 'Dean M Luehrs', '4x800 Meter', '11'),
(27, 'Rob Mainhardt', '4x800 Meter', '11');
--
-- Database: `trackSignUp`
--

-- --------------------------------------------------------

--
-- Table structure for table `whatEvents`
--

CREATE TABLE IF NOT EXISTS `whatEvents` (
  `studentID` int(4) unsigned NOT NULL AUTO_INCREMENT,
  `studentName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `eventName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `whichEvents` (
  ...
  `studentName` varchar(128) CHARACTER SET utf8 NOT NULL,
  `eventName` varchar(128) CHARACTER SET utf8 NOT NULL,
  `age` varchar(2) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`studentID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;
...
INSERT INTO `whichEvents` (`studentID`, `studentName`, `eventName`, `age`) VALUES
(1, 'Dean Luehrs', '4x800 Meter', '11');
--
-- Database: `trackSignUps`
--

-- --------------------------------------------------------

--
-- Table structure for table `trackEvents`
--

CREATE TABLE IF NOT EXISTS `trackEvents` (
  `competitionID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `StudentName` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
