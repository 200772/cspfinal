...
if ($_SERVER["REQUEST_METHOD"] == "POST")	//Check it is coming from a form
    {
		...
		$statement = $mysqli->prepare("UPDATE student SET studentName= ?, event=?, year=? WHERE competitionID = ?"); //prepare sql insert query - thank you(https://stackoverflow.com/questions/6514649/php-mysql-bind-param-how-to-prepare-statement-for-update-query)
